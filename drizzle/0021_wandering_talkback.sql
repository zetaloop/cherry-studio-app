...
INSERT INTO `__new_assistants`("id", "name", "prompt", "type", "emoji", "description", "model", "default_model", "settings", "enable_web_search", "enable_generate_image", "knowledge_recognition", "tags", "group", "isStar", "websearch_provider_id") SELECT "id", "name", "prompt", "type", "emoji", "description", "model", "default_model", "settings", "enable_web_search", "enable_generate_image", "knowledge_recognition", "tags", "group", "isStar", "websearch_provider_id" FROM `assistants`;--> statement-breakpoint
