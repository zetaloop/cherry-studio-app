...
type WebsearchProviderSettingsRouteProp = RouteProp<RootStackParamList, 'WebsearchProviderSettingsPage'>

export default function WebsearchProviderSettingsPage() {
